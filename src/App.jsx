...
const projects = [
  ...
  { n: '06', slug: 'social-ios-twitter-app', title: 'Social: iOS Twitter-style App', meta: 'iOS · UIKit · MVC · AFNetworking', text: 'An iOS social app prototype that mimics core Twitter-style timelines, navigation and post interactions.', context: 'Social was built as a mobile interface study for a Twitter-like experience: users needed to browse timeline-style posts, move through multiple screens, inspect map-based content and interact with a polished native iOS flow.', approach: 'I implemented the app with UIKit, using customised UITableView cells for timeline results, delegate and UITableViewDataSource patterns for updates, UINavigationController and UITabBarController for multi-screen MVC structure, and AFNetworking to retrieve post data from backend services.', highlights: [{title:'Custom Timeline Interface',text:'Used UITableView with customised UITableViewCell layouts to present social posts in a native, timeline-style browsing experience.'},{title:'Delegate-driven Updates',text:'Updated table content through the delegate pattern and UITableViewDataSource protocol, keeping data flow clear and aligned with UIKit conventions.'},{title:'Multi-screen MVC Navigation',text:'Implemented multiple MVC flows with UINavigationController and UITabBarController so users could move naturally between feed, detail and supporting views.'},{title:'Map Interaction Design',text:'Customised map views to make location-based content easier to explore and improve the overall mobile interaction experience.'},{title:'Backend Data Integration',text:'Integrated CocoaPods for dependency management and used AFNetworking to retrieve post information from backend servers.'}], role: 'IOS DEVELOPMENT · UIKIT · MOBILE ARCHITECTURE', external: 'https://github.com/ziyu562/iOS-App-to-Mimic-the-Functionalities-of-Twitter' },
]
...
function BioPage() {
  ...
  return <section className="bio-page" id="top">
    ...
    <div className="bio-photo-grid" aria-label="Bio field notes">
      <figure className="bio-photo-card is-wide"><img src="/media/photos/Bio/bio-field-drone-web.jpg" alt="Leo Liu flying a drone in a mountain landscape"/><figcaption><span>01</span>Fieldwork · Light, landscape and motion</figcaption></figure>
      <figure className="bio-photo-card is-tall"><img src="/media/photos/Bio/bio-graduation-web.jpg" alt="Leo Liu holding a graduation certificate"/><figcaption><span>02</span>Education · Systems practice</figcaption></figure>
      <figure className="bio-photo-card is-medium"><img src="/media/photos/Bio/bio-coast-web.jpg" alt="Leo Liu standing near a coastal rock formation"/><figcaption><span>03</span>Auckland · Coastal frame</figcaption></figure>
      <figure className="bio-photo-card is-small"><img src="/media/photos/Bio/bio-sakura-web.jpg" alt="Leo Liu under cherry blossoms beside a car"/><figcaption><span>04</span>Portrait · Everyday atmosphere</figcaption></figure>
      <figure className="bio-photo-card is-small"><img src="/media/photos/Bio/bio-wayfinder-web.jpg" alt="Leo Liu standing by a directional signpost"/><figcaption><span>05</span>Wayfinding · Between places</figcaption></figure>
    </div>
    <div className="bio-practice">
      <div><small>01 · EDUCATION</small><h2>Education</h2><div className="bio-practice-list"><p><strong>University of Auckland</strong><br/>Master of Science in Information Technology · Auckland, New Zealand<br/><span>March 2025 - May 2026</span></p><p><strong>Illinois Institute of Technology</strong><br/>Master of Science in Computer Science · Chicago, United States<br/><span>August 2016 - May 2018</span></p><p><strong>Nanjing University of Aeronautics and Astronautics</strong><br/>Bachelor of Engineering in Automation · Nanjing, China<br/><span>September 2012 - June 2016</span></p></div></div>
      <div><small>02 · WORK EXPERIENCE</small><h2>Professional Experience</h2><div className="bio-practice-list"><p><strong>Digital Marketing Technology Specialist · DD Immigration</strong><br/>Developed and maintained the MERN-stack company website, supported SEO structure, performance monitoring and system stability, and built multimedia content pipelines across RedNote and TikTok.<br/><span>Auckland · January 2026 - Present</span></p><p><strong>ESG AI Insight Assistant · Internship</strong><br/>Designed and developed an AI-powered ESG data assistant with AWS Lambda, DynamoDB, Bedrock and S3, including natural-language query processing, visualisation and report workflows.<br/><span>Auckland · August 2025 - November 2025</span></p></div></div>
      <div><small>03 · ACADEMIC EXPERIENCE</small><h2>Research & Teaching</h2><div className="bio-practice-list"><p><strong>Research Assistant & Teaching Assistant · IIT Database Group</strong><br/>Worked on database provenance, query optimisation and data-skipping systems in collaboration with Oracle Database Group, contributing to GProM and related published research.<br/><span>Chicago · August 2018 - December 2024</span></p><p><strong>Associate Editor · ICDE 2020, ICDE 2021 and ICDE 2022</strong><br/>Supported editorial service for international database research venues while continuing work across provenance, data relevance and trustworthy analytical systems.<br/><span>Chicago · Academic service</span></p></div></div>
      <div><small>04 · CREATIVE EXPERIENCE</small><h2>Visual Practice</h2><div className="bio-practice-list"><p><strong>Contracted Photographer · Visual China Group</strong><br/>Photographic practice focused on landscapes, portraits, cities and night skies, with image-making shaped by light, timing, atmosphere and place.</p><p><strong>Photography, Video & Content Production</strong><br/>Created photography and video assets for digital campaigns using Photoshop, CapCut and field production workflows, connecting visual craft with communication and growth work.</p></div></div>
    </div>
    <div className="bio-skills-section">
      <div className="bio-skills-heading"><small>05 · SKILLS</small><h2>Skills</h2><p>A practical stack across backend systems, cloud infrastructure, data analysis, web content and visual production.</p></div>
      <div className="bio-details bio-skills">
        <div><small>Digital Content & Web</small><span>Website content maintenance<br/>Digital publishing workflows<br/>Customer-focused web pages<br/>Content quality control<br/>SEO structure</span></div>
        <div><small>Technical Skills</small><span>HTML · CSS · JavaScript<br/>React / MERN<br/>Python · SQL · Git<br/>CMS-style content operations</span></div>
        <div><small>Backend & APIs</small><span>Java · Java servlets<br/>RESTful APIs<br/>HTTP request / response handling<br/>Go services</span></div>
        <div><small>Databases & CS</small><span>MySQL · Oracle · PostgreSQL<br/>MongoDB · database optimisation<br/>Data structures & algorithms<br/>OOP · distributed systems · MapReduce</span></div>
        <div><small>Cloud & Tooling</small><span>AWS Lambda · Amazon EC2<br/>DynamoDB · Bedrock · S3<br/>Git · ELK · Kibana<br/>JMeter · Docker</span></div>
        <div><small>Content Production</small><span>Photography · video editing<br/>Photoshop · CapCut<br/>RedNote · TikTok<br/>Multimedia campaign assets<br/>English · Chinese</span></div>
      </div>
    </div>
  </section>
}
